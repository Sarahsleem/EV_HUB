...
class CarProtectionFilm {
  ...
  factory CarProtectionFilm.fromJson(Map<String, dynamic> json) {
...
//   final int featuredMedia;
//   final Acf acf;
//   final String? featuredImage; // Added to handle the featured media URL
//
...
//     required this.acf,
//     this.featuredImage, // Optional field for the featured media URL
//   });
//
//   @override
...
//
//         ' featuredMediaUrl: $featuredImage,' +
//         '}';
//   }
//
...
//
//       featuredImage: featuredMediaUrl ?? this.featuredImage, acf: this.acf,
//     );
//   }
//
//   Map<String, dynamic> toMap() {
...
//
//       'featured_media_url': this.featuredImage,
//     };
//   }
//
...
//       acf: map['acf'], // Use the corrected key name
//       featuredImage: map['_embedded']?['wp:featuredmedia']?[0]?['media_details']?['sizes']?['thumbnail']?['source_url'], // Extract the featured media URL
//     );
//   }
// }