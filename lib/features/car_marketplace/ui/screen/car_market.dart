      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('images/png/gradient (3) 1 (1).png'),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
          ...
          Padding(
            ...
            child: ListView(
              children: [
                ...
                verticalSpace(20),
                Row(children: [
                  Text( S.of(context).newcars,style: TextStyles.inter18WhiteMedium,),
                  Spacer(),
            ...
            child: Text(
              ...
              verticalSpace(20),
                Row(children: [
                  Text( S.of(context).newcars,style: TextStyles.inter18WhiteMedium.copyWith(fontSize: 21),),
                  Spacer(),
            ...
            child: Text(
              ...
              style: TextStyle(color: Colors.white, fontSize: 12),
               ...
               Text( S.of(context).showrooms,style: TextStyles.inter18WhiteMedium.copyWith(fontSize: 21),),
           ...
           BlocBuilder<CarMarketCubitCubit,CarMarketCubitState>(
            ...
            return _buildShowroomCard(company.profileImage, Colors.white); // أو أي لون حسب الشركة
                    },
                  ),
                );
              },
